...
import { StudentAcademicStateContext, StudentAcademicActionsContext } from '../contexts/StudentAcademicContext';
...
const ModuleViewPage: React.FC = () => {
    ...
    // Safe Context Access
    const studentState = useContext(StudentAcademicStateContext);
    const studentActions = useContext(StudentAcademicActionsContext);
    const teacherData = useContext(TeacherAcademicContext);

    const studentData = useMemo(() => 
        (studentState && studentActions) ? { ...studentState, ...studentActions } : undefined,
        [studentState, studentActions]
    );
